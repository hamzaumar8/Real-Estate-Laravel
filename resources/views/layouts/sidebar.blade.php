 <!-- sidenav  -->
 <aside
     class="max-w-62.5 ease-nav-brand z-90 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-green-400 p-0 antialiased transition-transform duration-200 xl:left-0 xl:translate-x-0 ps xl:bg-green-400 shadow-soft-xl">
     <div class="h-19.5">
         ...
         <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="{{route('dashboard')}}"
             ...
             <x-application-logo class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8"
                 alt="main_logo" />
             <span class="ml-1 font-bold transition-all duration-200 ease-nav-brand">Logo</span>
         </a>
     </div>

     <hr class="h-px mt-0 bg-transparent bg-gradient-to-r from-transparent via-black/100 to-transparent mb-4" />
